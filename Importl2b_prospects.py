...
import json
import os
url = 'https://app.leads2b.com/api/v1/prospect/list' # Url para facilitar

headers = {
    'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJuYmYiOjE2NDU3MTAyODAsImlhdCI6MTY0NTcxMDI4MCwiY2giOiJSdzVqaHNZZUxQN01heW1xT3hTb1lodVpxYUp4UjJsVCIsInVoIjpudWxsfQ.1NyDutw9mNAWn8uyN1iLqixMknOD0R8zxLMjq0usUEs'
...
with tqdm(total=data_loading) as contador:  # criando uma barra de
    ...
    for i in range(data_loading):  # while data_form < data_de_hj_form: # criando o while comparando o dia atual ao dia do inicio do projeto
        ...
        with open(f'files/prospects/{data_str}.json', 'w', encoding='utf8') as dic:  # {data_str} # criando o arquivo fora do while
